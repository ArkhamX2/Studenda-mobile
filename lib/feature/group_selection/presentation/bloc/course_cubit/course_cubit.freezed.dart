...
class _$SuccessImpl implements _Success {
  const _$SuccessImpl(final List<CourseEntity> courses) : _courses = courses;
...
abstract class _Success implements CourseState {
  const factory _Success(final List<CourseEntity> courses) = _$SuccessImpl;
...
class __$$FailImplCopyWithImpl<$Res>
    extends _$CourseStateCopyWithImpl<$Res, _$FailImpl>
...
class _$FailImpl implements _Fail {
  ...
  @override
  String toString() {
    return 'CourseState.fail(message: $message)';
  }
...
abstract class _Fail implements CourseState {
